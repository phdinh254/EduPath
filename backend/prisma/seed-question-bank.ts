...
const ANH_Q: QSeed[] = [
  ...
  mc(
    KNOWLEDGE,
    'Choose the correct answer: There ___ a lot of students in the library now.',
    ['is', 'are', 'was', 'be'],
    1,
    "'There are' is used with a plural noun ('students').",
  ),
  mc(
    KNOWLEDGE,
    'Choose the correct answer: My brother is interested ___ playing football.',
    ['at', 'in', 'on', 'with'],
    1,
    "The fixed collocation is 'interested in' doing something.",
  ),
  mc(
    KNOWLEDGE,
    "Choose the word with the opposite meaning to 'ancient'.",
    ['old', 'modern', 'historic', 'traditional'],
    1,
    "'Modern' is the opposite of 'ancient' (very old).",
  ),
  mc(
    KNOWLEDGE,
    'Choose the correct answer: I usually ___ breakfast at 7 a.m.',
    ['have', 'having', 'has', 'to have'],
    0,
    "Subject 'I' with present simple takes the base form 'have'.",
  ),
  mc(
    KNOWLEDGE,
    ...
    1,
    "Two-syllable-plus adjectives form the comparative with 'more' + adjective.",
  ),
  mc(
    COMPREHENSION,
    'Choose the correct answer: By next year, she ___ her degree.',
    ['will complete', 'will have completed', 'completes', 'completed'],
    1,
    'Future perfect (will have + past participle) is used for an action completed before a specific point in the future.',
  ),
  mc(
    COMPREHENSION,
    'Choose the correct question tag: You like coffee, ___?',
    ['do you', "don't you", "aren't you", 'will you'],
    1,
    "Affirmative statement takes a negative tag: 'don't you'.",
  ),
  mc(
    COMPREHENSION,
    "Choose the word closest in meaning to 'diminish'.",
    ['increase', 'decrease', 'maintain', 'multiply'],
    1,
    "'Diminish' means to become smaller or less, similar to 'decrease'.",
  ),
  mc(
    COMPREHENSION,
    'Choose the correct answer: This is the house ___ I grew up.',
  ...
  mc(
    COMPREHENSION,
    'Choose the correct passive form: They are building a new bridge. → A new bridge ___.',
    ['is being built', 'is build', 'was being built', 'has been build'],
    0,
    'Present continuous passive: is/are + being + past participle.',
  ),
  mc(
    APPLICATION,
    "Choose the best response: 'I'm so sorry for being late.' — '___'",
    [
    ...
    0,
    "'No problem, don't worry about it' is an appropriate response to an apology.",
  ),
  mc(
    APPLICATION,
    'Choose the correct word: The committee will ___ a decision by Friday.',
    ['make', 'do', 'take', 'have'],
    0,
    "The correct collocation is 'make a decision'.",
  ),
  mc(
    APPLICATION,
    'Choose the correct sentence with a conditional clause: ___ it rains, we will stay at home.',
    ['Unless', 'If', 'Because', 'Although'],
    1,
    "'If it rains, we will stay at home' expresses a simple future condition.",
  ),
  mc(
    APPLICATION,
    "Choose the best paraphrase of: 'She rarely goes out on weekdays.'",
    [
      'She almost never goes out on weekdays.',
      'She always goes out on weekdays.',
      'She sometimes goes out on weekdays.',
      'She never stays home on weekdays.',
    ],
    0,
    "'Rarely' means 'almost never', matching the first option.",
  ),
  mc(
    APPLICATION,
    'Choose the correct answer: The teacher insisted that all students ___ the assignment on time.',
    ['submit', 'submits', 'submitted', 'will submit'],
    0,
    "After 'insist that', the subjunctive (base form) is used: 'submit'.",
  ),
  mc(
    HIGH_APPLICATION,
    "Choose the correct meaning of the idiom 'to hit the books'.",
    ['to study hard', 'to destroy books', 'to read for fun', 'to sell books'],
    0,
    "'Hit the books' is an idiom meaning to study hard.",
  ),
  mc(
    HIGH_APPLICATION,
    'Choose the sentence with correct use of a cleft structure.',
    [
      'It was John who broke the window.',
      'It was John broke the window.',
      'John was who broke the window.',
      'Was John who broke the window.',
    ],
    0,
    "The cleft sentence structure is: 'It was + subject + who/that + clause'.",
  ),
  mc(
    HIGH_APPLICATION,
    "Read: 'The committee's decision was met with widespread skepticism.' The word 'skepticism' is closest in meaning to:",
    ['enthusiasm', 'doubt', 'agreement', 'celebration'],
    1,
    "'Skepticism' means doubt or a questioning attitude.",
  ),
  mc(
    HIGH_APPLICATION,
    'Choose the correct answer: Not only ___ the exam, but she also got the highest score.',
    ['she passed', 'did she pass', 'she did pass', 'passed she'],
    1,
    "Negative inversion after 'Not only' at the start of a clause requires subject-auxiliary inversion: 'did she pass'.",
  ),
  mc(
    HIGH_APPLICATION,
    "Choose the best paraphrase of: 'The new regulation has rendered the old policy obsolete.'",
    [
      'The new regulation has made the old policy outdated.',
      'The new regulation has strengthened the old policy.',
      'The new regulation has no effect on the old policy.',
      'The old policy replaced the new regulation.',
    ],
    0,
    "'Rendered obsolete' means 'made outdated', matching the first option.",
  ),
];
...
const LY_Q: QSeed[] = [
  ...
  mc(
    ...
    ['V/m', 'A/m', 'T', 'Wb'],
    0,
    'Cường độ điện trường E được đo bằng vôn trên mét (V/m).',
  ),
  mc(
    KNOWLEDGE,
    'Hiện tượng quang điện ngoài là hiện tượng:',
    [
      'êlectron bị bật ra khỏi bề mặt kim loại khi bị chiếu ánh sáng thích hợp',
      'ánh sáng bị khúc xạ khi qua lăng kính',
      'kim loại nóng chảy khi bị chiếu sáng',
      'ánh sáng bị tán sắc',
    ],
    0,
    'Quang điện ngoài là hiện tượng êlectron bật ra khỏi bề mặt kim loại khi được chiếu ánh sáng có bước sóng thích hợp (nhỏ hơn giới hạn quang điện).',
  ),
  mc(
    KNOWLEDGE,
    'Trong thí nghiệm giao thoa ánh sáng Y-âng, khoảng vân i được tính bằng công thức:',
    ['i = λD/a', 'i = λa/D', 'i = aD/λ', 'i = λ/(aD)'],
    0,
    'Khoảng vân i = λD/a, với λ là bước sóng, D là khoảng cách từ khe đến màn, a là khoảng cách hai khe.',
  ),
  mc(
    COMPREHENSION,
    'Một vật dao động điều hòa, khi đi qua vị trí cân bằng thì:',
    [
      'tốc độ cực đại, gia tốc bằng 0',
      'tốc độ bằng 0, gia tốc cực đại',
      'cả tốc độ và gia tốc đều cực đại',
      'cả tốc độ và gia tốc đều bằng 0',
    ],
    0,
    'Tại vị trí cân bằng (li độ x=0), tốc độ đạt cực đại v_max=ωA còn gia tốc a=-ω²x=0.',
  ),
  mc(
    COMPREHENSION,
    'Khi tăng tần số của dòng điện xoay chiều qua tụ điện, dung kháng của tụ sẽ:',
    ['giảm', 'tăng', 'không đổi', 'bằng 0'],
    0,
    'Dung kháng Z_C = 1/(ωC), khi tần số (ω=2πf) tăng thì Z_C giảm.',
  ),
  mc(
    COMPREHENSION,
    'Tia X (tia Rơn-ghen) được tạo ra bằng cách nào?',
    [
      'cho chùm êlectron có động năng lớn đập vào một kim loại có nguyên tử lượng lớn',
      'chiếu ánh sáng tử ngoại qua lăng kính',
      'đun nóng chất khí ở áp suất thấp',
      'phóng xạ tự nhiên của các nguyên tố nặng',
    ],
    0,
    'Tia X được tạo ra khi chùm êlectron tốc độ lớn đập vào đối âm cực làm bằng kim loại nặng (như platin, vonfram), làm phát ra bức xạ tia X.',
  ),
];
...
const HOA_Q: QSeed[] = [
  ...
  mc(
    KNOWLEDGE,
    'Trong công nghiệp, kim loại nhôm được sản xuất bằng phương pháp:',
    [
    ...
    0,
    'Nhôm được sản xuất bằng phương pháp điện phân nóng chảy Al2O3 (có mặt criolit làm giảm nhiệt độ nóng chảy).',
  ),
  mc(
    KNOWLEDGE,
    'Polime nào sau đây được điều chế bằng phản ứng trùng ngưng?',
    ['polietilen', 'poli(vinyl clorua)', 'nilon-6,6', 'cao su buna'],
    2,
    'Nilon-6,6 được điều chế bằng phản ứng trùng ngưng giữa hexametylenđiamin và axit ađipic, giải phóng nước.',
  ),
  mc(
    KNOWLEDGE,
    'Chất nào sau đây là chất điện li mạnh?',
    ['CH3COOH', 'NaCl', 'H2O', 'NH3'],
    1,
    'NaCl là muối tan hoàn toàn, phân li hoàn toàn thành ion trong nước nên là chất điện li mạnh.',
  ),
  mc(
    COMPREHENSION,
    'Vì sao khi để lâu trong không khí ẩm, các vật dụng bằng sắt dễ bị gỉ?',
    [
      'sắt bị ăn mòn điện hóa do tiếp xúc với tạp chất kim loại khác và hơi ẩm có hòa tan CO2, O2',
      'sắt tự bốc cháy trong không khí',
      'sắt phản ứng với nitơ trong không khí',
      'sắt bị nóng chảy ở nhiệt độ thường',
    ],
    0,
    'Sắt có lẫn tạp chất (như cacbon) tiếp xúc với màng nước có hòa tan O2, CO2 tạo thành pin điện hóa vi mô, gây ăn mòn kim loại (gỉ sét).',
  ),
  mc(
    COMPREHENSION,
    'Phản ứng giữa CH3COOH và C2H5OH có xúc tác H2SO4 đặc, đun nóng, tạo ra este thuộc loại phản ứng:',
    [
      'este hóa, là phản ứng thuận nghịch',
      'trùng hợp',
      'trùng ngưng, một chiều',
      'oxi hóa - khử',
    ],
    0,
    'Phản ứng giữa axit và ancol tạo este (phản ứng este hóa) là phản ứng thuận nghịch, cần xúc tác axit và đun nóng.',
  ),
  mc(
    COMPREHENSION,
    'Vì sao trong quá trình luyện gang, người ta dùng CO khử oxit sắt thay vì dùng H2?',
    [
      'CO rẻ hơn, dễ tạo ra từ than cốc ngay trong lò cao',
      'CO có khả năng khử mạnh hơn H2',
      'H2 không khử được oxit sắt',
      'H2 gây nổ khi ở nhiệt độ cao trong lò',
    ],
    0,
    'Trong lò cao, CO được tạo ra ngay tại chỗ từ than cốc và không khí nóng, chi phí thấp hơn nhiều so với sản xuất và vận chuyển H2.',
  ),
  sa(
    APPLICATION,
    'Cho 2,7 gam Al phản ứng hoàn toàn với dung dịch HCl dư. Tính thể tích khí H2 thoát ra ở đktc (lít, dùng 22,4 l/mol, nhập số).',
    '3.36',
    'n(Al)=2,7/27=0,1 mol; 2Al+6HCl→2AlCl3+3H2 nên n(H2)=0,15 mol; V=0,15×22,4=3,36 lít.',
  ),
  sa(
    HIGH_APPLICATION,
    'Trung hòa 200ml dung dịch NaOH 0,5M bằng dung dịch HCl 1M. Tính thể tích dung dịch HCl cần dùng (ml, nhập số).',
    '100',
    'n(NaOH)=0,2×0,5=0,1 mol = n(HCl) cần; V(HCl)=n/C_M=0,1/1=0,1 lít=100 ml.',
  ),
];
...
const SINH_Q: QSeed[] = [
  ...
  mc(
    KNOWLEDGE,
    'Trong quá trình phiên mã, mạch ARN được tổng hợp theo chiều nào so với mạch khuôn?',
    ["3'→5'", "5'→3'", 'cả hai chiều', 'không theo chiều xác định'],
    1,
    "Enzim ARN polimeraza tổng hợp mạch ARN theo chiều 5'→3', dựa trên mạch khuôn 3'→5'.",
  ),
  mc(
    KNOWLEDGE,
    'Đơn vị tổ chức cơ sở của di truyền học ngoài nhân là:',
    [
      'nhiễm sắc thể',
    ...
    1,
    'Di truyền ngoài nhân (di truyền tế bào chất) liên quan đến ADN trong ti thể và lục lạp.',
  ),
  mc(
    KNOWLEDGE,
    'Hiện tượng ưu thế lai biến mất dần qua các thế hệ tự thụ phấn là do:',
    [
      'tỉ lệ dị hợp giảm dần, tỉ lệ đồng hợp tăng dần',
      'đột biến gen tăng lên',
      'số lượng NST thay đổi',
      'môi trường sống thay đổi',
    ],
    0,
    'Tự thụ phấn qua nhiều thế hệ làm tỉ lệ kiểu gen dị hợp giảm dần, đồng hợp tăng dần, làm giảm ưu thế lai (vốn có được nhờ trạng thái dị hợp).',
  ),
  mc(
    COMPREHENSION,
    'Vì sao đột biến gen lặn thường không biểu hiện ngay ra kiểu hình ở thế hệ đầu tiên?',
    [
      'do bị alen trội tương ứng lấn át trong cặp gen dị hợp',
      'do gen lặn không có khả năng phiên mã',
      'do gen lặn nằm ngoài nhân',
      'do đột biến gen lặn luôn gây chết',
    ],
    0,
    'Ở trạng thái dị hợp, alen trội quy định kiểu hình, alen lặn bị lấn át nên đột biến lặn thường tồn tại tiềm ẩn qua nhiều thế hệ trước khi biểu hiện ở trạng thái đồng hợp lặn.',
  ),
  mc(
    COMPREHENSION,
    'Vai trò của cách li địa lí trong quá trình hình thành loài mới bằng con đường địa lí là gì?',
    [
      'duy trì sự khác biệt về tần số alen và vốn gen do các nhân tố tiến hóa tạo ra giữa các quần thể',
      'trực tiếp tạo ra các alen mới',
      'không có vai trò trong tiến hóa',
      'chỉ có vai trò với thực vật',
    ],
    0,
    'Cách li địa lí ngăn cản giao phối giữa các quần thể, giúp duy trì và tích lũy sự khác biệt về vốn gen cho đến khi hình thành cách li sinh sản.',
  ),
  mc(
    COMPREHENSION,
    'Vì sao trong chọn giống, người ta thường sử dụng phương pháp gây đột biến kết hợp với chọn lọc?',
    [
      'đột biến tạo ra nguồn biến dị phong phú, chọn lọc giữ lại các biến dị có lợi phù hợp với mục tiêu chọn giống',
      'đột biến luôn tạo ra biến dị có lợi',
      'chọn lọc không cần đến biến dị',
      'phương pháp này chỉ áp dụng cho vi sinh vật',
    ],
    0,
    'Gây đột biến tạo nguồn biến dị di truyền phong phú (đa số trung tính hoặc có hại), sau đó chọn lọc để giữ lại các cá thể mang đột biến có lợi phù hợp với mục tiêu chọn giống.',
  ),
  tf(
    APPLICATION,
    'Xét phép lai hai cặp tính trạng phân li độc lập ở đậu Hà Lan: AaBb × AaBb (A: hạt vàng trội hoàn toàn so với a: hạt xanh; B: hạt trơn trội hoàn toàn so với b: hạt nhăn). Xét các mệnh đề về F1:',
    [
      'a) Tỉ lệ kiểu hình là 9:3:3:1',
      'b) Tỉ lệ cây có kiểu hình vàng, trơn chiếm 9/16',
      'c) Tỉ lệ cây thuần chủng (đồng hợp cả 2 cặp gen) chiếm 4/16',
      'd) Tỉ lệ cây có kiểu hình xanh, nhăn chiếm 3/16',
    ],
    [true, true, true, false],
    'Theo quy luật phân li độc lập, F1 có tỉ lệ kiểu hình 9:3:3:1 (a đúng), vàng-trơn (A-B-) chiếm 9/16 (b đúng), tỉ lệ đồng hợp cả 2 cặp (AABB,AAbb,aaBB,aabb) = 4/16 (c đúng). Xanh-nhăn (aabb) chỉ chiếm 1/16, không phải 3/16 nên d sai.',
  ),
  sa(
    APPLICATION,
    'Một phân tử ADN nhân đôi 3 lần liên tiếp. Tính số phân tử ADN con được tạo thành (nhập số).',
    '8',
    'Số ADN con = 2^k với k là số lần nhân đôi; 2^3 = 8.',
  ),
  sa(
    HIGH_APPLICATION,
    'Ở một loài, gen A quy định hoa đỏ trội hoàn toàn so với a quy định hoa trắng. Lai Aa × aa thu được 120 cây. Tính số cây hoa trắng dự kiến (nhập số).',
    '60',
    'Aa × aa cho tỉ lệ 1 Aa : 1 aa (1 đỏ : 1 trắng); số cây hoa trắng = 120/2 = 60.',
  ),
  sa(
    HIGH_APPLICATION,
    'Quần thể ngẫu phối có tần số alen A = 0,7, a = 0,3, đang cân bằng Hacđi-Vanbec. Tính tỉ lệ % kiểu gen Aa trong quần thể (nhập số, không kèm ký hiệu %).',
    '42',
...
const SU_Q: QSeed[] = [
  ...
  mc(
    KNOWLEDGE,
    'Hội nghị Ianta (2/1945) có sự tham gia của ba cường quốc nào?',
    [
      'Liên Xô, Mỹ, Anh',
      'Liên Xô, Mỹ, Pháp',
      'Mỹ, Anh, Pháp',
    ...
    0,
    'Hội nghị Ianta (4-11/2/1945) có sự tham gia của nguyên thủ ba cường quốc: Liên Xô, Mỹ và Anh.',
  ),
  mc(
    KNOWLEDGE,
    'Phong trào "Đồng khởi" (1959-1960) nổ ra đầu tiên tại tỉnh nào?',
    ['Bến Tre', 'Quảng Ngãi', 'Cà Mau', 'Tây Ninh'],
    0,
    'Phong trào Đồng khởi nổ ra đầu tiên ở huyện Mỏ Cày, tỉnh Bến Tre, sau đó lan rộng khắp miền Nam.',
  ),
  mc(
    KNOWLEDGE,
    'Chiến lược "Việt Nam hóa chiến tranh" là chiến lược chiến tranh của Mỹ được thực hiện dưới đời tổng thống nào?',
    ['Kennedy', 'Giônxơn', 'Níchxơn', 'Aixenhao'],
    2,
    'Chiến lược "Việt Nam hóa chiến tranh" được chính quyền Níchxơn thực hiện từ năm 1969.',
  ),
  mc(
    KNOWLEDGE,
    'Việt Nam chính thức trở thành thành viên của Liên hợp quốc vào năm nào?',
    ['1975', '1977', '1986', '1995'],
    1,
    'Việt Nam gia nhập Liên hợp quốc ngày 20/9/1977, trở thành thành viên thứ 149.',
  ),
  mc(
    COMPREHENSION,
    'Điểm mới của phong trào giải phóng dân tộc ở châu Á sau Chiến tranh thế giới thứ hai so với trước đó là gì?',
    [
      'diễn ra mạnh mẽ, giành thắng lợi ở hầu hết các nước, dẫn đến sự sụp đổ của hệ thống thuộc địa',
      'chỉ diễn ra ở một vài nước nhỏ',
      'không có sự lãnh đạo của các chính đảng',
      'hoàn toàn không có xung đột vũ trang',
    ],
    0,
    'Sau Thế chiến II, phong trào giải phóng dân tộc ở châu Á phát triển mạnh mẽ và giành thắng lợi rộng khắp, làm sụp đổ hệ thống thuộc địa của chủ nghĩa đế quốc.',
  ),
  mc(
    COMPREHENSION,
    'Vì sao Hiệp định Paris (1973) được coi là thắng lợi có ý nghĩa chiến lược của nhân dân Việt Nam?',
    [
      'buộc Mỹ công nhận độc lập, chủ quyền của Việt Nam và rút hết quân về nước, tạo thời cơ cho cách mạng miền Nam',
      'kết thúc hoàn toàn chiến tranh Việt Nam',
      'thống nhất đất nước ngay lập tức',
      'chỉ có ý nghĩa về mặt ngoại giao',
    ],
    0,
    'Hiệp định Paris buộc Mỹ rút hết quân viễn chinh và cam kết tôn trọng độc lập, chủ quyền Việt Nam, tạo ra thời cơ thuận lợi để quân dân ta tiến lên giải phóng hoàn toàn miền Nam.',
  ),
  mc(
    COMPREHENSION,
    'Nguyên nhân chủ quan quan trọng nhất dẫn đến thắng lợi của cuộc kháng chiến chống Mỹ, cứu nước là gì?',
    [
      'sự lãnh đạo đúng đắn, sáng suốt của Đảng đứng đầu là Chủ tịch Hồ Chí Minh',
      'sự viện trợ của các nước xã hội chủ nghĩa',
      'Mỹ tự động rút quân',
      'điều kiện tự nhiên thuận lợi',
    ],
    0,
    'Sự lãnh đạo đúng đắn, sáng suốt của Đảng Cộng sản Việt Nam với đường lối kết hợp đấu tranh quân sự - chính trị - ngoại giao là nhân tố chủ quan quyết định thắng lợi.',
  ),
  mc(
    COMPREHENSION,
    'Bài học kinh nghiệm nào từ công cuộc Đổi mới có ý nghĩa xuyên suốt đối với sự phát triển của Việt Nam hiện nay?',
    [
      'kiên định mục tiêu độc lập dân tộc gắn liền với chủ nghĩa xã hội, đổi mới toàn diện nhưng có bước đi, lộ trình phù hợp',
      'chỉ tập trung phát triển quân sự',
      'đóng cửa nền kinh tế để bảo hộ sản xuất trong nước',
      'phụ thuộc hoàn toàn vào viện trợ nước ngoài',
    ],
    0,
    'Đổi mới nhấn mạnh kiên định mục tiêu độc lập dân tộc gắn với CNXH, đồng thời đổi mới toàn diện, đồng bộ nhưng có bước đi, lộ trình phù hợp với điều kiện đất nước — bài học vẫn còn nguyên giá trị.',
  ),
];
...
const DIA_Q: QSeed[] = [
  ...
  mc(
    KNOWLEDGE,
    'Việt Nam nằm trong múi giờ số mấy theo giờ GMT?',
    ['số 6', 'số 7', 'số 8', 'số 9'],
    1,
    'Việt Nam nằm trong múi giờ số 7 theo giờ GMT.',
  ),
  mc(
    KNOWLEDGE,
    'Vùng biển nào của nước ta được xác định là ranh giới an ninh quốc gia trên biển?',
    ['nội thủy', 'lãnh hải', 'vùng đặc quyền kinh tế', 'thềm lục địa'],
    1,
    'Lãnh hải rộng 12 hải lí tính từ đường cơ sở được coi là biên giới quốc gia trên biển.',
  ),
  mc(
    COMPREHENSION,
    'Nguyên nhân chủ yếu làm cho tài nguyên rừng nước ta bị suy giảm mạnh trong giai đoạn trước đây là:',
    [
      'khai thác quá mức, cháy rừng và mở rộng diện tích đất nông nghiệp',
      'sâu bệnh hại',
      'khí hậu lạnh giá',
      'thiếu nguồn nước tưới',
    ],
    0,
    'Khai thác gỗ quá mức, đốt rừng làm nương rẫy và mở rộng diện tích canh tác nông nghiệp là các nguyên nhân chủ yếu làm suy giảm tài nguyên rừng.',
  ),
  mc(
    COMPREHENSION,
    'Việc hình thành cơ cấu nông nghiệp hàng hóa ở Đồng bằng sông Cửu Long gắn liền với thế mạnh nào?',
    [
      'đất phù sa màu mỡ, nguồn nước dồi dào, khí hậu cận xích đạo thuận lợi cho sản xuất lúa và thủy sản quy mô lớn',
      'địa hình núi cao hiểm trở',
      'khí hậu lạnh giá quanh năm',
      'nguồn khoáng sản phong phú',
    ],
    0,
    'ĐBSCL có đất phù sa màu mỡ, nguồn nước sông Mê Công dồi dào, khí hậu cận xích đạo — điều kiện lý tưởng để phát triển nông nghiệp hàng hóa quy mô lớn, đặc biệt là lúa gạo và thủy sản.',
  ),
  tf(
    APPLICATION,
    'Về đặc điểm khí hậu Việt Nam, xét các mệnh đề sau:',
    [
      'a) Khí hậu nhiệt đới ẩm gió mùa, có sự phân hóa đa dạng theo không gian và thời gian',
      'b) Miền Bắc có mùa đông lạnh do ảnh hưởng của gió mùa Đông Bắc',
      'c) Lượng mưa và độ ẩm lớn quanh năm trên cả nước',
      'd) Khí hậu hoàn toàn giống nhau giữa các vùng miền',
    ],
    [true, true, false, false],
    'Khí hậu Việt Nam nhiệt đới ẩm gió mùa, phân hóa đa dạng theo không gian, thời gian (a đúng); miền Bắc có mùa đông lạnh do gió mùa Đông Bắc (b đúng). Lượng mưa phân bố không đều, có mùa khô rõ rệt ở nhiều vùng nên c sai; khí hậu phân hóa rõ rệt giữa các miền, không giống nhau nên d cũng sai.',
  ),
  tf(
    APPLICATION,
    'Về đặc điểm sông ngòi Việt Nam, xét các mệnh đề sau:',
    [
      'a) Mạng lưới sông ngòi dày đặc nhưng phần lớn là sông nhỏ, ngắn, dốc',
      'b) Chế độ nước sông theo sát chế độ mưa (mùa lũ và mùa cạn)',
      'c) Sông ngòi nước ta giàu phù sa',
      'd) Tất cả các sông đều bắt nguồn và chảy trọn vẹn trong lãnh thổ Việt Nam',
    ],
    [true, true, true, false],
    'Sông ngòi nước ta dày đặc, chủ yếu là sông nhỏ, ngắn, dốc do địa hình 3/4 là đồi núi (a đúng); chế độ nước theo sát chế độ mưa, có mùa lũ - mùa cạn (b đúng); sông giàu phù sa do xâm thực mạnh ở miền núi (c đúng). Nhiều hệ thống sông lớn (như sông Hồng, sông Mê Công) bắt nguồn từ nước ngoài nên d sai.',
  ),
  sa(
    APPLICATION,
    'Một địa phương có diện tích 5000 km² và dân số 2 triệu người. Tính mật độ dân số (người/km², nhập số).',
    '400',
    'Mật độ dân số = dân số / diện tích = 2.000.000 / 5000 = 400 người/km².',
  ),
  sa(
    APPLICATION,
    'Cho biết tổng diện tích rừng của một tỉnh là 300.000 ha, diện tích tự nhiên toàn tỉnh là 1.000.000 ha. Tính độ che phủ rừng của tỉnh (%, nhập số).',
    '30',
    'Độ che phủ rừng = diện tích rừng / diện tích tự nhiên × 100% = 300.000/1.000.000×100=30%.',
  ),
  sa(
    APPLICATION,
    'Một vùng có tỉ suất sinh thô 18‰, tỉ suất tử thô 6‰. Tính tỉ suất gia tăng dân số tự nhiên (‰, nhập số).',
    '12',
    'Tỉ suất gia tăng tự nhiên = tỉ suất sinh - tỉ suất tử = 18 - 6 = 12‰.',
  ),
  sa(
    APPLICATION,
    'Việt Nam nằm trong khoảng vĩ độ nào (chỉ nhập số vĩ độ Bắc lớn nhất, làm tròn, đơn vị độ)?',
    '23',
    "Điểm cực Bắc của Việt Nam ở khoảng vĩ độ 23°23'B (làm tròn 23°).",
  ),
  sa(
    HIGH_APPLICATION,
    'Một tỉnh có sản lượng lúa 500.000 tấn, dân số 400.000 người. Tính bình quân sản lượng lúa theo đầu người (kg/người, nhập số).',
    '1250',
    'Bình quân = 500.000.000 kg / 400.000 người = 1250 kg/người.',
  ),
  sa(
    HIGH_APPLICATION,
    'Cho biểu đồ nhiệt độ trung bình tháng 1 là 16°C và tháng 7 là 29°C tại một địa điểm. Tính biên độ nhiệt năm (°C, nhập số).',
    '13',
    'Biên độ nhiệt năm = nhiệt độ tháng nóng nhất - nhiệt độ tháng lạnh nhất = 29 - 16 = 13°C.',
  ),
];
